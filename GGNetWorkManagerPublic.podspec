...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GGNetWorkManagerPublic.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1563084860@qq.com/GGNetWorkManagerPublic'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1563084860@qq.com' => '1563084860@qq.com' }
  s.source           = { :git => 'https://github.com/1563084860@qq.com/GGNetWorkManagerPublic.git', :tag => s.version.to_s }
